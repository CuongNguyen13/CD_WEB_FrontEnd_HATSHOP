          ...
          <div className="col-xl-4" >
            ...
            <div className="card mb-4 mb-xl-0">
              ...
              <div className="card-body text-center">
                ...
                <img style={{width:"200px",height:"200px",display:"block", margin:"0 auto"}} id="imageProfileload" className="img-account-profile rounded-circle mb-2 imageProfileload" src={profile && profile.avatarlink} alt="" onChange={handleChange}/>
                {selectedImage && (
                <img style={{width:"200px",height:"200px",display:"none"}}  id="imageProfileupload" className="img-account-profile rounded-circle mb-2 imageProfileupload"
                src={URL.createObjectURL(selectedImage)} alt="" onChange={handleChange}/>
                )}
                {/* Profile picture help block*/}
                <div className="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                {/* Profile picture upload button*/}
                <input className="btn btn-primary" id="btnFile" type="file" onChange={(event) => {console.log(event.target.files[0]); setSelectedImage(event.target.files[0]);
        }}></input>
              </div>
            </div>
          </div>
            ...
            <div className="card mb-4">
              ...
              <div className="card-body">
                <form style={{height:"407px"}} onSubmit={handleSubmit}>
                  {/* Form Group (username)*/}
                  <div className="mb-3">
                    <input className="form-control" id="email" name='email' type="text" placeholder="Email" value={profile && profile.email} onChange={handleChange}/>
                  </div>
                  {/* Form Row*/}
                  ...
                  <div className="mb-3">
                    <input className="form-control" id="inputEmailAddress" type="email" name='age' placeholder="Enter your age"value={profile && profile.age} onChange={handleChange}/>
                  </div>
                  {/* Form Row*/}
                  <div className="row gx-3 mb-3">
                    ...
                    {/* Form Group (birthday)*/}
                    <div className="col-md-6">
                      <input className="form-control" id="inputBirthday" type="text" name="birthday" placeholder="Enter your birthday"value={profile && profile.dateOfBirth} onChange={handleChange}/>
                    </div>
                  </div>
                  {/* Save changes button*/}
