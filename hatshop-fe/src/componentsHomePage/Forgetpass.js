...
function Forgetpass() {
    ...
    return (
            ...
            <div className="row">
                ...
                <h3 className="mb-3">ForgetPass ?</h3>
                    ...
                    <div className="col-md-7 pe-0">
                        ...
                        <form className="row g-4" onSubmit={handleSubmit}>
                            ...
                            <div className="input-group">
                                ...
                                <input type="text" className="form-control" placeholder="Enter Username" name='email' value={input.email || ""}  onChange={handleChange} />
                            </div>
                            </div>
                            <div className="col-12">
                            <button type="submit" className="btn btn-primary px-4 float-end mt-4">SendMail</button>
                            </div>
                        </form>
                        </div>
                    </div>
