...
function UserTr(props) {
    ...
    return (
        <tr>
            ...
            <td><button onClick={() => { setModal(true) }} type='button' className={enableU ? "btn btn-success" : "btn btn-danger"}>
                {enableU ? "Mở" : "Khóa"}
            </button>
            </td>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className={enable ? "btn btn-success" : "btn btn-danger"} data-bs-dismiss="modal" onClick={() => { handlDelete() }}>{enableU ? "Mở" : "Khóa"}</button>
